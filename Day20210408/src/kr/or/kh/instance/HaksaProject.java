...
public class HaksaProject {
	...
	public static void main(String[] args) {
        ...
        if(cnt==1) {
        	haksaObj.register(cnt, input, haksaList);
        	if(cnt==4) {
        		continue;
        	}
        }else if(cnt==2) {
        	haksaObj.search(input, haksaList);
        	...
        	haksaObj.delete(input, haksaList);
        	...
        	haksaObj.update(input, haksaList);
