...
public class HaksaFunction {
	public static void register(int cnt, Scanner input, ArrayList<HashMap<String, String>> haksaList) {
	...
	public static void update(Scanner input, ArrayList<HashMap<String, String>> haksaList) {
		// 수정시작
